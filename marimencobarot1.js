...
cb1++;
  if(input1.value == "-2,2"){
        aksi1.innerHTML = "Jawaban benar \\[A(2,2)\\xrightarrow{R[0,90^{\\circ}]}{A}'(3,-2)\\]"
     }
    else{
      if (cb1 == 2){
        aksi1.innerHTML = "\\[A(x,y)\\xrightarrow{R[0,90^{\\circ}]}{A}'(-y,x)\\]"
        aksi1.innerHTML +="<p>\\[A(2,2)\\xrightarrow{R[0,90^{\\circ}]}{A}'(...,...)\\]</p>"
      }
      else {
...
cb2++;
  if(input2.value == "-3,-7"){
        aksi2.innerHTML = "Jawaban benar \\[B(-7,3)\\xrightarrow{R[0,90^{\\circ}]}{B}'(-3,-7)\\]"
     }
    else{
      if (cb2 == 2){
        aksi2.innerHTML = "\\[B(x,y)\\xrightarrow{R[0,90^{\\circ}]}{B}'(-y,x)\\]"
        aksi2.innerHTML +="<p>\\[B(-7,3)\\xrightarrow{R[0,90^{\\circ}]}{B}'(...,...)\\]</p>"
      }
      else {
...
let cb3 = 0;
  ...
  cb3++;
    if(input3.value == "5,4"){
          aksi3.innerHTML = "Jawaban benar \\[C(4,-5)\\xrightarrow{R[0,90^{\\circ}]}{C}'(5,4)\\]"
       }
      else{
        if (cb3 == 2){
          aksi3.innerHTML = "\\[C(x,y)\\xrightarrow{R[0,90^{\\circ}]}{C}'(-y,x)\\]"
          aksi3.innerHTML +="<p>\\[C(4,-5)\\xrightarrow{R[0,90^{\\circ}]}{C}'(...,...)\\]</p>"
        }
        else {
...
let cb4 = 0;
    ...
    cb4++;
      if(input4.value == "5,-2"){
            aksi4.innerHTML = "Jawaban benar \\[D(-2,-5)\\xrightarrow{R[0,90^{\\circ}]}{D}'(5,-2)\\]"
          }
        else{
          if (cb4 == 2){
            aksi4.innerHTML = "\\[D(x,y)\\xrightarrow{R[0,90^{\\circ}]}{D}'(-y,x)\\]"
            aksi4.innerHTML +="<p>\\[D(-2,-5)\\xrightarrow{R[0,90^{\\circ}]}{D}'(...,...)\\]</p>"
          }
          else {
